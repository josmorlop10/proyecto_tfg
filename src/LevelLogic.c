...
const unsigned char* global_levels_array[] = {f_map_0,f_map_1,f_map_2,f_map_3,map2,map1_alt,f_map_4};
const unsigned char* global_level_objects_array[] = {objects_f_map_0, objects_f_map_1, objects_f_map_2, objects_f_map_3,objects_map2,objects_map1_alt,objects_f_map_4};
const unsigned char* global_level_blocks_array[] = { blocks_f_map_0, blocks_f_map_1, blocks_f_map_2, blocks_f_map_3, blocks_map2, blocks_map1_alt,blocks_f_map_4 };
